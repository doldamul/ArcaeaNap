...
def save_to_db(data):
    ...
    try:
        ...
        for entry in data:
            ...
            cursor.execute('''
                INSERT INTO charts
                (song_id, difficulty, level, bp, perceived_bp, s_bp, note_count, cut_200, ignore_chart, skill_issues, hard_bpm)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
